...
export default { sembunyikanikutiToogle }
export { sembunyikanikutiToogle }
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
async function sembunyikanikutiToogle(UUID = "") {
  try {
    ...
    user.sembunyikanikuti = !user.sembunyikanikuti;
    database[user.index] = user;
    await writeFileJSON(userdatabase, database, { spaces: 2 });
    return { status: true, message: `sukses ${user.sembunyikanikuti ? 'menyembunyikan' : 'membuka'} sembunyikanikuti` };
  } catch (error) {
    return { status: false, message: "gagal ganti sembunyikanikuti", error }
  }
}

async function main() {
  try {
    console.log(await sembunyikanikutiToogle('7838a342-05b1-447a-8c5d-5ec109461067'));
  } catch (error) {
    console.log(error);
  }
}
