...
export default { profilprivatToogle }
export { profilprivatToogle }
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
async function profilprivatToogle(UUID = "") {
  try {
    ...
    user.profilprivat = !user.profilprivat;
    database[user.index] = user;
    await writeFileJSON(userdatabase, database, { spaces: 2 });
    return { status: true, message: `sukses ${user.profilprivat ? 'menyembunyikan' : 'membuka'} profilprivat` };
  } catch (error) {
    return { status: false, message: "gagal ganti profilprivat", error }
  }
}
...
async function main() {
  try {
    console.log(await profilprivatToogle('7838a342-05b1-447a-8c5d-5ec109461067'));
  } catch (error) {
    console.log(error);
  }
}
