...
export default { sembunyikandiikutiToogle }
export { sembunyikandiikutiToogle }
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
async function sembunyikandiikutiToogle(UUID = "") {
  try {
    ...
    user.sembunyikandiikuti = !user.sembunyikandiikuti;
    database[user.index] = user;
    await writeFileJSON(userdatabase, database, { spaces: 2 });
    return { status: true, message: `sukses ${user.sembunyikandiikuti ? 'menyembunyikan' : 'membuka'} sembunyikandiikuti` };
  } catch (error) {
    return { status: false, message: "gagal ganti sembunyikandiikuti", error }
  }
}
...
async function main() {
  try {
    console.log(await sembunyikandiikutiToogle('7838a342-05b1-447a-8c5d-5ec109461067'));
  } catch (error) {
    console.log(error);
  }
}
